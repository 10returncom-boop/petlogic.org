...
<footer class="site-footer footer-animated" style="background-image:url('images/footer-default.gif');"><div class="footer-overlay"><div class="container"><p>&copy; 2026 PetLogic 寵物知識百科. 共{len(ALL_ARTICLES)}篇文章.</p></div></div></footer>
</body>
</html>'''
