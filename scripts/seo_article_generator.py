...
<footer class="site-footer footer-animated" style="background-image:url('../images/footer-{get_footer_theme(cat)}.gif');"><div class="footer-overlay"><div class="container"><p>&copy; 2026 PetLogic 寵物知識百科. 用科學邏輯理解你的毛孩.</p></div></div></footer>
</body>
</html>'''
    return html
